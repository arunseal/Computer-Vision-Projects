function image_order = find_ordered_homography(im, sift_r, harris_r, harris_thresh,harris_sigma, num_putative_matches, ransac_n)
    ...
    for i = 1:n_img
        for j = i+1:n_img
            [~ , H{i,j}, num_inliers(i,j), residual(i,j)] = ...
                stitch_pair(im{i}, im{j}, sift_r, harris_r, harris_thresh, ...
